              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">New Borrower</li>
                  </ol>
                </nav>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <h6 class="mb-0 text-uppercase">New Borrower</h6>
                <hr/>
                <form class="row g-3" method="post" action="controlador/new_prestamo" >
                  
                  <h6 class="mb-0 text-uppercase">Borrower</h6>
                  <div class="col-4">
                  ...
                  <div class="col-3">
                    ...
                    <select name="tipoContrato" class="form-select mb-3" aria-label=".form-select-sm example" required>
		    							<option value="" selected>Select Type of Contract</option>
