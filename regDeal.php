                 ...
                 <div class="card-body">
                   ...
                   <div class="table-responsive mt-3">
                     <table id= "example" class="table align-middle table-striped">
                       ...
                       <tbody>
                      <?php foreach($conn->query("SELECT * FROM users") as $producto):?>
                        <?php if($producto["id_user"] > 1):?>
                        <tr>
                          ...
                          <?php if($producto["rol"] == 1):?>
                            <td>Admin</td>
                          <?php elseif($producto["rol"] == 2):?>
                            <td>Amigos Prestamos Personal</td>
                          <?php else:?>
                            <td>Dealer</td>
                          <?php endif;?>
                          <td>
                             <div class="table-actions d-flex align-items-center gap-3 fs-6">
                               <a href="editarUser?id=<?=$producto["id_user"]?>" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Editar"><i class="bi bi-pencil-fill"></i></a>
                               <a href="javascript:AlertaEliminarItem('<?=$producto["id_user"]?>', 'del_dealer');" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Eliminar"><i class="bi bi-trash-fill"></i></a>
                             </div>
                           </td>
                        </tr>
                        <?php endif;?>
