...
<head>
  ...
  <title>Registrar Co-Borrower</title>
</head>
              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Register Co-Borrower</li>
                  </ol>
                </nav>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <h6 class="mb-0 text-uppercase">Register Co-Borrower</h6>
                <label class="text-warning">For security, you cannot close the registration process until registration is complete</label>
                <hr/>
                <form class="row g-3" method="post" action="controlador/new_coBorrower?Signer=<?=$_REQUEST['Signer']?>&id_prestario=<?=$_REQUEST['id_prestario']?>">
                <h6 class="mb-0 text-uppercase">Co-Borrower</h6>
                  <div class="col-4">
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      <button name ="enviar" type="submit" class="btn btn-primary" value =" ">Continue</button>
                    </div>
                  </div>
