                  ...
                  <div class="card-body">
                      ...
                      <div class="card shadow-none border">
                        <div class="card-header">
                          <h6 class="mb-0">Contract Number of Borrower</h6>
                        </div>
                        <div class="card-body">
                          <div class="row g-3">
                            <form action="controlador/newNumberContract?id_prestario=<?=$datosPrestario["id_prestario"]?>" method = "POST">
                              <div class="col-3">
                                  <label class="form-label">* Contract Number</label>
                                  <input name="ContractNumber" type="text" class="form-control" required>
                              </div>
                              <hr/>
                              <label class="form-label">* Required Field</label>
                              <div class="col-12">
                                <div class="d-grid">
                                  <button type="submit" class="btn btn-primary">Asign Contract Number</button>
                                </div>
                              </div>    
                            </form>
                          </div>
