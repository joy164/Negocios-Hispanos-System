              ...
              <div class="card-body">
                ...
                <h6 class="mb-0 text-uppercase">Name</h6>
                  <div class="col-6">
                    ...
                    <input name="nombre" type="text" class="form-control" value ="<?= $datosPerfil['name']?>" required>
                  </div>
                  <div class="col-6">
                    <label class="form-label">* Apellido</label>
                    <input name="apellido" type="text" class="form-control" value ="<?= $datosPerfil['lastName']?>" required>
                  </div>
                  <hr/>
                  <h6 class="mb-0 text-uppercase">Contact</h6>
                  <div class="col-12">
                    <label class="form-label">* Address</label>
                    <input name="direccion" type="text" class="form-control" value ="<?= $datosPerfil['address']?>" required>
                  </div>
                  <div class="col-12">
                    <label class="form-label">* Email</label>
                    <input name="corr" type="email" class="form-control" value ="<?= $datosPerfil['correo']?>" required>
                  </div>
                  <hr/>
                  <h6 class="mb-0 text-uppercase">Security</h6>
                  <div class="col-12">
                    <label class="form-label">* Password</label>
                    <input name="pass" type="text" class="form-control" value ="<?= $datosPerfil['password']?>" required>
                  </div>
                  </div>
                  <hr/>
