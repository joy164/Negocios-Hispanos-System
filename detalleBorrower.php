                ...
                <div class="card shadow-sm border-0">
                  <div class="card-body">
                      ...
                      <div class="col-20 col-lg-12 text-md-end">
                        <?php if($datosPrestario["refRegistrada"] == 0):?>
                            <a href="ContractNumber.php?id_prestario=<?=$datosPrestario['id_prestario']?>" class="btn btn-sm btn-warning">Asign Contract Number <i class="lni lni-write"></i></a>
                          ...
                          <?php else:?>     
                            <?php if($datosPrestario["contGenerado"] == 0):?>
                              ...
                              <a href="detalleReferencias?id_prestario=<?=$datosPrestario["id_prestario"]?>" class="btn btn-sm btn-secondary">Borrower References<i class="bi bi-person-fill"></i></a>
                              <a href="regPrestamos" class="btn btn-sm btn-primary"> <i class="lni lni-angle-double-left"></i> Return</a>
                            <?php else:?>
