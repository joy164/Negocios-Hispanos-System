<?php
    ...
    $consulta = $conn->prepare("SELECT * FROM users WHERE id_user = ?");
    $consulta->bind_param('s', $_SESSION['id_user']);
    $consulta->execute();

    $resultado = $consulta->get_result();
    $datosPerfil = $resultado->fetch_assoc();
    $conn->close();
       ...
       <!--start content-->
          <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title2 pe-3">Others</div>
              <div class="ps-3">
            ...
            <!--end breadcrumb-->
            <?php if($img == 1):?>
              <div class="profile-cover1 bg-dark"></div>
            <?php elseif($img == 2):?>
              <div class="profile-cover2 bg-dark"></div>
            <?php elseif($img == 3):?>
              <div class="profile-cover3 bg-dark"></div>            
            <?php elseif($img == 4):?>             
              <div class="profile-cover4 bg-dark"></div>
            <?php endif;?>              
                  ...
                  <div class="card-body">
                      ...
                      <div class="card shadow-none border">
                        <div class="card-header">
                          <h6 class="mb-0">Information of user</h6>
                        </div>
                        <div class="card-body">
                          <div class="row g-3">
                            <div class = col-4>
                              <label class="form-label">Email</label>
                              <input type="text" class="form-control" value="<?=$datosPerfil["correo"]?>" readonly>
                            </div>
                              <div class="col-4">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-control" value="<?=$datosPerfil["name"]?>" readonly>
                            </div>
                            <div class="col-4">
                                <label class="form-label">Apellido</label>
                                <input type="text" class="form-control" value="<?=$datosPerfil["lastName"]?>" readonly>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="card-body">
                            <div class ="row g-3">
                              <div class="col-6">
                                ...
                                <input type="text" class="form-control" value="<?=$datosPerfil["address"]?>" readonly>
                              </div>
                                <div class="col-6">
                                  <label class="form-label">Password</label>
                                  <input type="text" class="form-control" value="<?=$datosPerfil["password"]?>" readonly>
                              </div>
                            </div>
